export const Icons = {
  groups: {
    ...
    class: 'mt-1 h-8 w-8 flex-shrink-0 fill-fuchsia-400 dark:fill-fuchsia-300',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-fuchsia-400 dark:fill-neutral-300 dark:hs-tab-active:fill-fuchsia-300 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  house: {
    ...
    class:
      'h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:text-fuchsia-400 dark:text-neutral-300 dark:hs-tab-active:text-fuchsia-300 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  arrowUp: {
    ...
    class: 'h-5 w-5 flex-shrink-0 text-fuchsia-400 dark:text-fuchsia-300',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
